...
namespace PuntoDeVentaAlm.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                //var user = new ApplicationUser { UserName = model.Email, Email = model.Email, ID_SUCURSAL = model.ID_SUCURSAL , ID_ALMACEN = model.ID_ALMACEN };
                ...
                if (result.Succeeded)
                {
                    ...
                    ViewBag.Confirma = "<div class=\"alert alert-succes\"><button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button><strong>El STOCK no fue ingresado.</strong> </div>";
